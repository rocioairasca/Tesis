...
- Privadas (requieren token): `/api/users`, `/api/lots`, `/api/products`, `/api/usages`, `/api/stats`, `/api/weather`, `/api/rain-records`, `/api/planning`, `/api/vehicles`, `/api/notifications`
